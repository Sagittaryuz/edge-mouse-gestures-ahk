...
O iniciador consulta o arquivo publicado no GitHub antes de executar o script. Se houver uma versão nova, ele cria uma cópia `.bak` da versão anterior e atualiza o arquivo local.
